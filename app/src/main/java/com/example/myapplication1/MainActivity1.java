...
public class MainActivity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JsonObjectRequest jsonRequest=new JsonObjectRequest(Request.Method.GET, "http://192.168.0.57:8000/files/test.json", null, new Response.Listener<JSONObject>() {
            @Override
            public void onResponse(JSONObject response) {
                try {
                    ...
                    if (imageFile != null && !imageFile.equals("")) {
                        ...
                        imageView.setImageUrl("http://192.168.0.57:8000/files/" + imageFile, imageLoader);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
